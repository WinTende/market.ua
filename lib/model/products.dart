...
List<Product> products = [
  ...
  description: 'Бренд разнообразных картофельных чипсов, основанный в 1938 году. Чипсы Lay’s производятся компанией Frito-Lay, принадлежащей PepsiCo Inc. с 1970 года. Другие бренды компании Frito-Lay включают Fritos,',
  ...
  Product(//shuzo
    ...
    title: 'Чіпси 165г \nPRINGLES картопляні \nзі смаком сиру',
    description: 'е, що проводиться під цим брендом, звичайно називають чіпсами. Але це не зовсім вірно, цю продукцію вірніше називати незграбним формулюванням «легка картопляна закуска». Справа в тому, що в складі Pringles картоплі лише 40%',
  ...
  Product(//shuzo
    ...
    description: 'Те, що проводиться під цим брендом, звичайно називають чіпсами. Але це не зовсім вірно, цю продукцію вірніше називати незграбним формулюванням «легка картопляна закуска». Справа в тому, що в складі Pringles картоплі лише 40%',
